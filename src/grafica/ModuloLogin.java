...
import gestione_account.ControlLogin;
...
public class ModuloLogin extends JFrame implements ActionListener{
    ...
    public JLabel userLabel, passLabel, Forgot, Wrong, costast,background,welcome,errorematricola,errorepassword,erroreempty;

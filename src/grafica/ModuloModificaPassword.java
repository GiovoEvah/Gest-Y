...
import gestione_account.ModificaPasswordControl;
...
public class ModuloModificaPassword extends JFrame implements ActionListener{
	...
	ModuloModificaPassword(Utente utente){
		...
		errorepassworduguale.setBounds(410,50,200,60);
		...
		errorecorrispondenza.setBounds(410,50,200,60);
		...
		errorecampovuoto1.setBounds(410,50,200,60);
		...
		errorecampovuoto2.setBounds(410,50,200,60);
		...
		errorecampovuoto3.setBounds(410,50,200,60);
		...
		errorecampivuoti.setBounds(410,50,200,60);
